...
var vnode = (0, _snabbdom.h)('div#container', [(0, _snabbdom.h)('h1', 'Hello Sabbdom'), (0, _snabbdom.h)('p', '这是一个p标签')]);
var app = document.querySelector('#app');
var oldVnode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _snabbdom.h)('div#container.cls', [(0, _snabbdom.h)('h1', 'Hello world'), (0, _snabbdom.h)('p', 'Hello p')]); //上次  这次

  vnode = patch(oldVnode, vnode); //清空
  //错误
  // patch(endVnode, null);
  // 通过创建注释节点来实现

  vnode = patch(vnode, (0, _snabbdom.h)('!')); // Vnode节点仍然存在
